...
public:
  ...
  RevVecInstDefaults().SetMnemonic("vmand.mm %vd, %vs2, %vs1"      ).SetFunct3(OPV::MVV).SetFunct6(0b011001).SetImplFunc(&vmnandmm).SetrdClass(RevRegClass::RegVEC).Setrs1Class(RevRegClass::RegVEC    ).Setrs2Class(RevRegClass::RegVEC).SetFormat(RVVTypeOpv).SetOpcode(0b1010111),
  ...
  RevVecInstDefaults().SetMnemonic("vmandn.mm %vd, %vs2, %vs1"     ).SetFunct3(OPV::MVV).SetFunct6(0b011000).SetImplFunc(&vmnandmm).SetrdClass(RevRegClass::RegVEC).Setrs1Class(RevRegClass::RegVEC    ).Setrs2Class(RevRegClass::RegVEC).SetFormat(RVVTypeOpv).SetOpcode(0b1010111),
  RevVecInstDefaults().SetMnemonic("vmxor.mm %vd, %vs2, %vs1"      ).SetFunct3(OPV::MVV).SetFunct6(0b011011).SetImplFunc(&vmnandmm).SetrdClass(RevRegClass::RegVEC).Setrs1Class(RevRegClass::RegVEC    ).Setrs2Class(RevRegClass::RegVEC).SetFormat(RVVTypeOpv).SetOpcode(0b1010111),
  RevVecInstDefaults().SetMnemonic("vmor.mm %vd, %vs2, %vs1"       ).SetFunct3(OPV::MVV).SetFunct6(0b011110).SetImplFunc(&vmormm  ).SetrdClass(RevRegClass::RegVEC).Setrs1Class(RevRegClass::RegVEC    ).Setrs2Class(RevRegClass::RegVEC).SetFormat(RVVTypeOpv).SetOpcode(0b1010111),
  RevVecInstDefaults().SetMnemonic("vmnor.mm %vd, %vs2, %vs1"      ).SetFunct3(OPV::MVV).SetFunct6(0b011101).SetImplFunc(&vmnandmm).SetrdClass(RevRegClass::RegVEC).Setrs1Class(RevRegClass::RegVEC    ).Setrs2Class(RevRegClass::RegVEC).SetFormat(RVVTypeOpv).SetOpcode(0b1010111),
  RevVecInstDefaults().SetMnemonic("vmorn.mm %vd, %vs2, %vs1"      ).SetFunct3(OPV::MVV).SetFunct6(0b011100).SetImplFunc(&vmnandmm).SetrdClass(RevRegClass::RegVEC).Setrs1Class(RevRegClass::RegVEC    ).Setrs2Class(RevRegClass::RegVEC).SetFormat(RVVTypeOpv).SetOpcode(0b1010111),
  RevVecInstDefaults().SetMnemonic("vmxnor.mm %vd, %vs2, %vs1"     ).SetFunct3(OPV::MVV).SetFunct6(0b011111).SetImplFunc(&vmnandmm).SetrdClass(RevRegClass::RegVEC).Setrs1Class(RevRegClass::RegVEC    ).Setrs2Class(RevRegClass::RegVEC).SetFormat(RVVTypeOpv).SetOpcode(0b1010111),
