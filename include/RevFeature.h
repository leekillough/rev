...
enum RevFeatureType : uint32_t {
  ...
  RV_ZBA      = 1 << 21,  ///< RevFeatureType: Zba-extension
  RV_ZBB      = 1 << 22,  ///< RevFeatureType: Zbb-extension
  RV_ZBC      = 1 << 23,  ///< RevFeatureType: Zbc-extension
  RV_ZBS      = 1 << 24,  ///< RevFeatureType: Zbs-extension
  RV_ZTSO     = 1 << 25,  ///< RevFeatureType: Ztso-extension
};
