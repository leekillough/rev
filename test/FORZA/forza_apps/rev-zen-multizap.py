...
zen.addParams({
  ...
  "zenQSizeLimit" : 1024*1024*1024,   # zenQ size limit
...
#         # "numHarts" : 16,
#         "clock" : "1.0GHz",                           # Clock
#         "memSize" : 1024*1024*1024+(1024*1024*1024),                   # Memory size in bytes
#         "machine" : "[0:RV64GC]",                     # Core:Config; RV64I for core 0
#         "startAddr" : "[0:0x00000000]",               # Starting address for core 0
#         "memCost" : "[0:1:10]",                       # Memory loads required 1-10 cycles
#         "args"    : "2",
...
zap_link0.connect( (zap_iface0, "rtr_port", "1ns"), (router, "port0", "1ns") )
...
rza_link0.connect( (rza_iface, "rtr_port", "1ns"), (router, "port4", "1ns") )

zen_link0 = sst.Link("zen_link")
zen_link0.connect( (zen_iface, "rtr_port", "1ns"), (router, "port5", "1ns") )

zqm_link0 = sst.Link("zqm_link")
zqm_link0.connect( (zqm_iface, "rtr_port", "1ns"), (router, "port6", "1ns") )
