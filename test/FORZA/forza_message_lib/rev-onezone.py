...
parser.add_argument("--numZaps", type=int, help="Number of ZAPs per Zone", default=2)
parser.add_argument("--numHarts", type=int, help="Number of HARTs per ZAP", default=1)
parser.add_argument("--program", help="The program executable to run in the simulation", default="forza_message_test.exe")
...
zap_cpu0.addParams({
        ...
        "args"    : "0",
        "program" : os.getenv("REV_EXE", args.program),  # Target executable
