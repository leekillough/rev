...
exe_name = "forza_send_twozone_onezap.exe"
...
zen0.addParams({
  ...
  "enablePrecinctNIC": True   # enable the precinct NIC?
})
...
zap_cpu0_0.addParams({
        ...
        "program": os.getenv("REV_EXE", exe_name),  # Target executable
...
# --------------------------
rzaMsg0 = sst.Component("rzaMsg0", "revcpu.RevCPU")
rzaMsg0.addParams({
    "verbose": 5,                                # Verbosity
    "numCores": 2,                               # Number of cores
    "clock": "1.0GHz",                           # Clock
...
rzaMsg0_lspipe = rzaMsg0.setSubComponent("rza_ls", "revcpu.RZALSCoProc")
rzaMsg0_lspipe.addParams({
    "clock": "1.0GHz",
    "verbose": 9,
})

rzaMsg0_amopipe = rzaMsg0.setSubComponent("rza_amo", "revcpu.RZAAMOCoProc")
rzaMsg0_amopipe.addParams({
    "clock": "1.0GHz",
    "verbose": 9,
})

rzaMsg0_lsq = rzaMsg0.setSubComponent("memory", "revcpu.RevBasicMemCtrl")
rzaMsg0_lsq.addParams({
    "verbose": "9",
    "clock": "2.0Ghz",
    "max_loads": 16,
    "max_stores": 16,
...
ifaceRzaMsg0 = rzaMsg0_lsq.setSubComponent("memIface", "memHierarchy.standardInterface")
ifaceRzaMsg0.addParams({
    "verbose": VERBOSE
})

memctrlRzaMsg0 = sst.Component("memoryRzaMsg0", "memHierarchy.MemController")
memctrlRzaMsg0.addParams({
    "debug": DEBUG_MEM,
    "debug_level": DEBUG_LEVEL,
    "clock": "2GHz",
    "verbose": VERBOSE,
...
memoryRzaMsg0 = memctrlRzaMsg0.setSubComponent("backend", "memHierarchy.simpleMem")
memoryRzaMsg0.addParams({
    "access_time": "100ns",
    "mem_size": "8GB"
})
...
# TODO: MAKE THE PARAMS HERE MATCH AN HBM
# --------------------------
rzaMsg1 = sst.Component("rzaMsg1", "revcpu.RevCPU")
rzaMsg1.addParams({
    "verbose": 5,                                # Verbosity
    "numCores": 2,                               # Number of cores
    "clock": "1.0GHz",                           # Clock
...
rzaMsg1_lspipe = rzaMsg1.setSubComponent("rza_ls", "revcpu.RZALSCoProc")
rzaMsg1_lspipe.addParams({
    "clock": "1.0GHz",
    "verbose": 9,
})

rzaMsg1_amopipe = rzaMsg1.setSubComponent("rza_amo", "revcpu.RZAAMOCoProc")
rzaMsg1_amopipe.addParams({
    "clock": "1.0GHz",
    "verbose": 9,
})

rzaMsg1_lsq = rzaMsg1.setSubComponent("memory", "revcpu.RevBasicMemCtrl")
rzaMsg1_lsq.addParams({
    "verbose": "9",
    "clock": "2.0Ghz",
    "max_loads": 16,
    "max_stores": 16,
...
ifaceRzaMsg1 = rzaMsg1_lsq.setSubComponent("memIface", "memHierarchy.standardInterface")
ifaceRzaMsg1.addParams({
    "verbose": VERBOSE
})

memctrlRzaMsg1 = sst.Component("memoryRzaMsg1", "memHierarchy.MemController")
memctrlRzaMsg1.addParams({
    "debug": DEBUG_MEM,
    "debug_level": DEBUG_LEVEL,
    "clock": "2GHz",
    "verbose": VERBOSE,
...
memoryRzaMsg1 = memctrlRzaMsg1.setSubComponent("backend", "memHierarchy.simpleMem")
memoryRzaMsg1.addParams({
    "access_time": "100ns",
    "mem_size": "8GB"
})
...
zap0_0_ring_nic = zap_cpu0_0.setSubComponent("ring_nic", "forza.RingNetNIC")
zap0_0_ring_iface = zap0_0_ring_nic.setSubComponent("iface", "merlin.linkcontrol")
...
rzaMsg0_nic = rzaMsg0.setSubComponent("zone_nic", "forza.zopNIC")
rzaMsg0_iface = rzaMsg0_nic.setSubComponent("iface", "merlin.linkcontrol")

zen_nic0 = zen0.setSubComponent("zone_nic", "forza.zopNIC")
zen_iface0 = zen_nic0.setSubComponent("iface", "merlin.linkcontrol")

zen_ring_nic0 = zen0.setSubComponent("ring_nic", "forza.RingNetNIC")
zen_ring_iface0 = zen_ring_nic0.setSubComponent("iface", "merlin.linkcontrol")

zqm_nic0 = zqm0.setSubComponent("zone_nic", "forza.zopNIC")
zqm_iface0 = zqm_nic0.setSubComponent("iface", "merlin.linkcontrol")

zqm_ring_nic0 = zqm0.setSubComponent("ring_nic", "forza.RingNetNIC")
zqm_ring_iface0 = zqm_ring_nic0.setSubComponent("iface", "merlin.linkcontrol")

router0 = sst.Component("router0", "merlin.hr_router")
router0.setSubComponent("topology", "merlin.singlerouter")

ring_router0 = sst.Component("ring_router0", "merlin.hr_router")
ring_router0.setSubComponent("topology", "merlin.singlerouter")
...
rzaMsg0_nic.addParams(nic_params)
rzaMsg0_iface.addParams(net_params)
...
zap0_0_ring_nic.addParams(nic_params)
zap0_0_ring_iface.addParams(net_params)
zen_ring_nic0.addParams(nic_params)
zen_ring_iface0.addParams(net_params)
zqm_ring_nic0.addParams(nic_params)
zqm_ring_iface0.addParams(net_params)
ring_router0.addParams(net_params)
ring_router0.addParams(ring_rtr_params)
...
zap1_0_ring_nic = zap_cpu1_0.setSubComponent("ring_nic", "forza.RingNetNIC")
zap1_0_ring_iface = zap1_0_ring_nic.setSubComponent("iface", "merlin.linkcontrol")
...
rzaMsg1_nic = rzaMsg1.setSubComponent("zone_nic", "forza.zopNIC")
rzaMsg1_iface = rzaMsg1_nic.setSubComponent("iface", "merlin.linkcontrol")

zen_nic1 = zen1.setSubComponent("zone_nic", "forza.zopNIC")
zen_iface1 = zen_nic1.setSubComponent("iface", "merlin.linkcontrol")

zen_ring_nic1 = zen1.setSubComponent("ring_nic", "forza.RingNetNIC")
zen_ring_iface1 = zen_ring_nic1.setSubComponent("iface", "merlin.linkcontrol")

zqm_nic1 = zqm1.setSubComponent("zone_nic", "forza.zopNIC")
zqm_iface1 = zqm_nic1.setSubComponent("iface", "merlin.linkcontrol")

zqm_ring_nic1 = zqm1.setSubComponent("ring_nic", "forza.RingNetNIC")
zqm_ring_iface1 = zqm_ring_nic1.setSubComponent("iface", "merlin.linkcontrol")

router1 = sst.Component("router1", "merlin.hr_router")
router1.setSubComponent("topology", "merlin.singlerouter")

ring_router1 = sst.Component("ring_router1", "merlin.hr_router")
ring_router1.setSubComponent("topology", "merlin.singlerouter")
...
rzaMsg1_nic.addParams(nic_params)
rzaMsg1_iface.addParams(net_params)
...
zap1_0_ring_nic.addParams(nic_params)
zap1_0_ring_iface.addParams(net_params)
zen_ring_nic1.addParams(nic_params)
zen_ring_iface1.addParams(net_params)
zqm_ring_nic1.addParams(nic_params)
zqm_ring_iface1.addParams(net_params)
ring_router1.addParams(net_params)
ring_router1.addParams(ring_rtr_params)
...
# -- RZA MSG TO MEMORY
link_iface_memMsg0 = sst.Link("link_iface_memMsg0")
link_iface_memMsg0.connect((ifaceRzaMsg0, "port", "50ps"), (memctrlRzaMsg0, "direct_link", "50ps"))
...
# -- RZA MSG TO MEMORY
link_iface_memMsg1 = sst.Link("link_iface_memMsg1")
link_iface_memMsg1.connect((ifaceRzaMsg1, "port", "50ps"), (memctrlRzaMsg1, "direct_link", "50ps"))
...
rza_link0.connect((rza_iface0, "rtr_port", "1us"), (router0, "port1", "1us"))

rzaMsg0_link0 = sst.Link("rzaMsg_link0")
rzaMsg0_link0.connect((rzaMsg0_iface, "rtr_port", "1us"), (router0, "port4", "1us"))

zen_link0 = sst.Link("zen_link0")
zen_link0.connect((zen_iface0, "rtr_port", "1us"), (router0, "port2", "1us"))

zqm_link0 = sst.Link("zqm_link0")
zqm_link0.connect((zqm_iface0, "rtr_port", "1us"), (router0, "port3", "1us"))

# -- Zone 0 Ring
zap_ring_link0 = sst.Link("zap_ring_link0")
zap_ring_link0.connect((zap0_0_ring_iface, "rtr_port", "1us"), (ring_router0, "port0", "1us"))

zen_ring_link0 = sst.Link("zen_ring_link0")
zen_ring_link0.connect((zen_ring_iface0, "rtr_port", "1us"), (ring_router0, "port1", "1us"))

zqm_ring_link0 = sst.Link("zqm_ring_link0")
zqm_ring_link0.connect((zqm_ring_iface0, "rtr_port", "1us"), (ring_router0, "port2", "1us"))
...
rza_link1.connect((rza_iface1, "rtr_port", "1us"), (router1, "port1", "1us"))

rzaMsg1_link0 = sst.Link("rzaMsg_link1")
rzaMsg1_link0.connect((rzaMsg1_iface, "rtr_port", "1us"), (router1, "port4", "1us"))

zen_link1 = sst.Link("zen_link1")
zen_link1.connect((zen_iface1, "rtr_port", "1us"), (router1, "port2", "1us"))

zqm_link1 = sst.Link("zqm_link1")
zqm_link1.connect((zqm_iface1, "rtr_port", "1us"), (router1, "port3", "1us"))

# -- Zone 1 Ring
zap_ring_link1 = sst.Link("zap_ring_link1")
zap_ring_link1.connect((zap1_0_ring_iface, "rtr_port", "1us"), (ring_router1, "port0", "1us"))

zen_ring_link1 = sst.Link("zen_ring_link1")
zen_ring_link1.connect((zen_ring_iface1, "rtr_port", "1us"), (ring_router1, "port1", "1us"))

zqm_ring_link1 = sst.Link("zqm_ring_link1")
zqm_ring_link1.connect((zqm_ring_iface1, "rtr_port", "1us"), (ring_router1, "port2", "1us"))
