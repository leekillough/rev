...
ifaceRzaMsg = rzaMsg_lsq.setSubComponent("memIface", "memHierarchy.standardInterface")
ifaceRzaMsg.addParams({
    "verbose": VERBOSE
})

memctrlRzaMsg = sst.Component("memoryRzaMsg", "memHierarchy.MemController")
memctrlRzaMsg.addParams({
    "debug": DEBUG_MEM,
    "debug_level": DEBUG_LEVEL,
    "clock": "2GHz",
    "verbose": VERBOSE,
...
memoryRzaMsg = memctrlRzaMsg.setSubComponent("backend", "memHierarchy.simpleMem")
memoryRzaMsg.addParams({
    "access_time": "100ns",
    "mem_size": "8GB"
})
...
rzaMsg_nic.addParams(nic_params)
rzaMsg_iface.addParams(net_params)
...
# -- RZA MSG TO MEMORY
link_iface_memMsg = sst.Link("link_iface_memMsg")
link_iface_memMsg.connect((ifaceRzaMsg, "port", "50ps"), (memctrlRzaMsg, "direct_link", "50ps"))
...
rzaMsg_link0 = sst.Link("rzaMsg_link")
rzaMsg_link0.connect((rzaMsg_iface, "rtr_port", "1us"), (router, "port5", "1us"))
