...
zqm_lc = zqm_module.setSubComponent("m_zop_iface", "Forza.zenZopNIC", 0)
zqm_lc.addGlobalParamSet("networkLinkControl_params")
zqm_zopapi_lc = zqm_lc.setSubComponent("iface", "merlin.linkcontrol", 0)
zqm_zopapi_lc.addGlobalParamSet("networkLinkControl_params")
zqm_link = sst.Link("zqm_link")
zqm_link.connect( (zqm_zopapi_lc, "rtr_port", "1us"), (router, "port1", "1us") )
zqm_lc.addParams({"verbose": 10})
