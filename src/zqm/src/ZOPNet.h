...
enum class zopOpc : uint8_t {
  ...
  Z_MSG_ZQMSET  = 0b11110100,   /// zopOpc: MESSAGING ZQM Setup // TODO: add to forzarev
  Z_MSG_ZQMHARTDONE  = 0b11110101,   /// zopOpc: MESSAGING ZQM Notify Hart Completion  // TODO: add to forzarev and zop spec
  Z_MSG_ACK     = 0b11110010,   /// zopOpc: MESSAGING Send Ack
  Z_MSG_EXCP    = 0b11110011,   /// zopOpc: MESSAGING Send exception

  // -- THREAD MIGRATION --
  // TODO: Add to ForzaRev version
