...
bool RevScratchpad::ReadMem(unsigned Hart, uint64_t Addr, size_t Len, void *Target, const MemReq& req){//, Interfaces::StandardMem::Request::flags_t flags){
...
bool RevScratchpad::WriteMem( unsigned Hart, uint64_t Addr, size_t Len, const void *Data){// Interfaces::StandardMem::Request::flags_t flags){
