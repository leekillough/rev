...
bool RevBasicMemCtrl::sendAMORequest(
  ...
  switch( RevFlagAtomic( Flags ) ) {
    ...
    case RevFlag::F_AMOSUB:   stat = MemCtrlStats::AMOSubPending  ; break;
    case RevFlag::F_AMOTHRES: stat = MemCtrlStats::AMOThrsPending ; break;
    case RevFlag::F_AMOFADD:  stat = MemCtrlStats::AMOFAddPending ; break;
    case RevFlag::F_AMOFSUB:  stat = MemCtrlStats::AMOFSubPending ; break;
    case RevFlag::F_AMOFSUBR: stat = MemCtrlStats::AMOFSubrPending; break;
